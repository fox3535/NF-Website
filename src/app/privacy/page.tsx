 ...
 *
 *   - no forms, no inputs, no email capture, no accounts, no API routes
 ...
 *
 * Nothing here claims a retention period, a storage location, a security
 * guarantee or a ticket-provider relationship, because none of those are
 * established in this repository. See docs/site-compliance.md.
 */
export default function PrivacyPage() {
  return (
    ...
    >
      ...
      <p>
        This website does not currently have any forms, sign up fields,
        accounts or contact forms. There is no way to submit personal
        information to us through this site, and we do not ask for your name,
        email address, phone number or payment details anywhere on it.
      </p>
      <p>
      ...
      <p>
        We do not use that technical information to identify individual
      ...
      <p>
        Because the site does not collect personal information from you, we do
        not use personal information for website purposes. The technical
        processing described above exists only to deliver the website, keep it
        working and protect it from abuse.
      </p>
      ...
      <p>
        Our hosting provider operates infrastructure in more than one country,
        so information involved in delivering this website may be processed
      ...
      <p>
        Using this website does not require you to give us personal
        information, so there is nothing you are being asked to consent to in
        order to browse it.
      </p>
      <p>
        If we later add something that does collect personal information, such
        as an email signup, we will ask for your consent clearly and
        separately at that point, explain what we will use it for, and let you
        withdraw that consent at any time. We will not treat browsing this site
        as consent to receive marketing.
      </p>

      <h2>Marketing communications</h2>
      <p>
        We do not currently send marketing email from this website, and there
        is no way to subscribe to anything on it. If we introduce an email
        list, joining it will be an active choice you make, every message will
        identify us and include a working unsubscribe link, and unsubscribing
        will be honoured.
      </p>
      ...
      <p>
        ...
        challenge how it is being handled. Because this website does not
        collect personal information, we would generally hold nothing about you
        from your use of it.
      </p>
      <p>
      ...
      <p>
        ...
        collected for, or as long as we are required to keep it. Where we hold
      ...
      <h2>Children</h2>
      <p>
        Our events are family friendly and children are welcome at them. This
        website does not knowingly collect personal information from anyone,
        including children.
      </p>
